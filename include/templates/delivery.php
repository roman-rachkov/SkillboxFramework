<main class="page-delivery">
    ...
    <section class="page-delivery__info">
        ...
        <ul class="page-delivery__list">
            <li>
                <b class="page-delivery__item-title">Стандартная доставка - <?=getSetting('delivery_price')?> РУБ / БЕСПЛАТНО (ДЛЯ ЗАКАЗОВ ОТ <?=getSetting('minimal_price_free_delivery')?> РУБ)</b>
                <p class="page-delivery__item-desc">
                    Примерный срок доставки составит около 2-7 рабочих дней, в зависимости от адреса доставки.
                </p>
            </li>
            <li>
                <b class="page-delivery__item-title">В день покупки - <?=(int)getSetting('delivery_price') * 2?> РУБ</b>
                <p class="page-delivery__item-desc">
            ...
            <li>
                <b class="page-delivery__item-title">Доставка с примеркой перед покупкой по Москве - <?=getSetting('delivery_price')?> РУБ / БЕСПЛАТНО (ПРИ ВЫКУПЕ НА СУММУ ОТ <?=getSetting('minimal_price_free_delivery')?> РУБ)</b>
                <p class="page-delivery__item-desc">
